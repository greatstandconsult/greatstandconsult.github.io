...
async function loadSubmissions(){
  ...
  try{
    ...
    for(const d of s.docs){
      ...
      const c=document.createElement("article");c.className="submission-card";
      const h=document.createElement("h3");h.textContent=title;
      const m=document.createElement("div");m.className="submission-meta";m.textContent="Student: "+(sub.studentEmail||sub.studentId||"Unknown");
      const t=document.createElement("div");t.className="submission-meta";t.textContent=sub.submittedAt?.toDate?"Submitted: "+sub.submittedAt.toDate().toLocaleString():"Submitted: Pending timestamp";
      const a=document.createElement("div");a.className="submission-answer";a.textContent=sub.answer||"(No answer provided)";
      c.append(h,m,t,a);list.appendChild(c);
    }
