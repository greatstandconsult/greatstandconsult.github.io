...
function setAdminPanelsVisible(show){["adminPanel","assignmentAdminPanel","testAdminPanel","studentAdminPanel","submissionsAdminPanel","testResultsAdminPanel"].forEach(id=>{const el=$(id);if(el)el.style.display=show?"block":"none";});}
...
const firebaseConfigForStudentCreation={apiKey:"AIzaSyCX_ZC18wviACEgTzTLBQiD95HVZg2oxDY",authDomain:"great-stand-consult.firebaseapp.com",projectId:"great-stand-consult",storageBucket:"great-stand-consult.firebasestorage.app",messagingSenderId:"759290092567",appId:"1:759290092567:web:4e873f1ad166cb54d11052",measurementId:"G-BPTN65KHK7"};
